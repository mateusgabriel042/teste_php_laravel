						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									<h3>Escreva-nos uma mensagem @auth @else<span style="font-size:12px;" class="text-danger">[Você precisa fazer o login primeiro]</span>@endauth</h3>
								</div>
								<form class="form-contact form contact_form" method="post" action="{{route('contact.store')}}" id="contactForm" novalidate="novalidate">
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Seu assunto<span>*</span></label>
												<input name="subject" type="text" id="subject" placeholder="Digite seu Seu">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input id="phone" name="phone" type="number" placeholder="Digite seu Telefone">
											</div>	
										</div>
										<div class="col-12">
											<div class="form-group message">
												<label>Mensagem<span>*</span></label>
												<textarea name="message" id="message" cols="30" rows="9" placeholder="Digite sua Mensagema"></textarea>
											</div>
										</div>
										<div class="col-12">
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								<div class="single-info">
									...
									<h4 class="title">Ligue-nos agora:</h4>
									<ul>
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			<div class="modal-header">
				<h2 class="text-success">Obrigada!</h2>
	...
	<div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-warning">Algo deu errado.</p>
			</div>
		  </div>
		</div>
	</div>
