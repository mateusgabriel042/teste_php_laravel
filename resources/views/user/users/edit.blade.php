...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('users.update',$user->id)}}">
        ...
        <input id="inputTitle" type="text" name="name" placeholder="Digite o Nome"  value="{{$user->name}}" class="form-control">
        @error('name')
        ...
        <div class="form-group">
          ...
          <input id="inputEmail" type="email" name="email" placeholder="Digite o Email"  value="{{$user->email}}" class="form-control">
          @error('email')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        {{-- <div class="form-group">
          ...
          <input id="inputPassword" type="password" name="password" placeholder="Digite a Senha"  value="{{$user->password}}" class="form-control">
          @error('password')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div> --}}
        ...
        @endphp
        <div class="form-group">
            <label for="role" class="col-form-label">Papel</label>
            <select name="role" class="form-control">
                <option value="">-----Selevione o Papel-----</option>
