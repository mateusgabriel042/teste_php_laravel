...
<div class="card">
    <h5 class="card-header">Adicionar Poste</h5>
    <div class="card-body">
      <form method="post" action="{{route('post.store')}}">
        ...
        <div class="form-group">
          <label for="quote" class="col-form-label">Nome</label>
        ...
        <div class="form-group">
          <label for="tags">Etiquete</label>
          <select name="tags[]" multiple  data-live-search="true" class="form-control selectpicker">
              <option value="">--Selecione qualquer etiquete--</option>
        ...
        <div class="form-group">
          ...
          <select name="added_by" class="form-control">
              <option value="">--Selecione qualquer autor--</option>
...
<script>
    ...
    $(document).ready(function() {
      $('#quote').summernote({
        placeholder: "Escrever cotação de detalhes.....",
          tabsize: 2,
          height: 100
      });
    });
