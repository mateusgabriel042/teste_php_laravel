...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="short_des" class="col-form-label">Pequena descrição <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="phone" class="col-form-label">Telefone/Celular <span class="text-danger">*</span></label>
